...
import { LayoutDashboard, Server, Key, LogOut, Moon, Sun, HeartPulse, Users, Settings, FlaskConical, Gauge, ShieldCheck } from 'lucide-react'
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { path: '/auth-systems', label: 'Auth Systems', icon: ShieldCheck },
    ...(user?.is_superadmin ? [
